/* -*-pgsql-c-*- */
/*
 * $Header: /cvsroot/pgpool/pgpool-II/parser/pool_memory.h,v 1.1.1.1 2006/09/08 03:36:42 t-ishii Exp $
 *
...
extern void pool_memory_delete(POOL_MEMORY_POOL *pool_memory);
